    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className={cn(
            ...
            "p-4 md:p-6 lg:p-8",
            role === "ADMIN" && "bg-slate-100/70 border border-slate-200/60",
role === "DOSEN" && "bg-emerald-50/40 border border-emerald-100/50",
role === "KEUANGAN" && "bg-teal-50/40 border border-teal-100/50",
role === "MAHASISWA" && "bg-violet-50/40 border border-violet-100/50",
            // Default fallback
            !role && "bg-amber-200"
          )}>
          {children}
