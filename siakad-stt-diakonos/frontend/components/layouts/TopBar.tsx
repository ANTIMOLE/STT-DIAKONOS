      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <div>
          ...
          <p className="hidden text-xs md:text-sm text-muted-foreground sm:block">
            {user?.role === "ADMIN" && (
  <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-100/80 px-2.5 py-0.5 text-xs font-medium text-slate-700 ring-1 ring-inset ring-slate-200/60">
...
{user?.role === "DOSEN" && (
  <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50/70 px-2.5 py-0.5 text-xs font-medium text-emerald-700 ring-1 ring-inset ring-emerald-100/60">
...
{user?.role === "KEUANGAN" && (
  <span className="inline-flex items-center gap-1.5 rounded-full bg-teal-50/70 px-2.5 py-0.5 text-xs font-medium text-teal-700 ring-1 ring-inset ring-teal-100/60">
...
{user?.role === "MAHASISWA" && (
  <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-50/70 px-2.5 py-0.5 text-xs font-medium text-violet-700 ring-1 ring-inset ring-violet-100/60">
