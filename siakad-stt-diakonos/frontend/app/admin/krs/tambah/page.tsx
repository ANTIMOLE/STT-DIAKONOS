  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <Button variant="outline" onClick={() => router.push('/admin/krs')} className='cursor-pointer
        ...
        <CardContent className="overflow-visible space-y-6 pb-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <Button type="submit" disabled={!canSubmit || isSubmitting} className='cursor-pointer
                              transition-all duration-200
                              active:scale-90'>
