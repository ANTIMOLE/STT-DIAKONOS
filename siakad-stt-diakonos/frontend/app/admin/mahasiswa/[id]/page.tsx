        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-semibold">{mahasiswa.namaLengkap}</span>?
              <br />
              <span className="text-red-600">
                Tindakan ini tidak dapat dibatalkan dan akan menghapus seluruh data terkait (KRS, KHS, nilai, presensi).
              </span>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
