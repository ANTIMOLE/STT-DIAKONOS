    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex items-start justify-between">
          ...
          <Button onClick={openUploadDialog} className="gap-2 cursor-pointer
                              transition-all duration-200
                              active:scale-90">
      ...
      <Dialog open={showUploadDialog} onOpenChange={setShowUploadDialog}>
        <DialogContent className="bg-white">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleUpload} disabled={isSubmitting} className='cursor-pointer
                              transition-all duration-200
                              active:scale-90'>
      ...
      <Dialog open={showRenameDialog} onOpenChange={setShowRenameDialog}>
        <DialogContent className="bg-white">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleRename} disabled={isSubmitting} className='cursor-pointer
                              transition-all duration-200
                              active:scale-90'>
