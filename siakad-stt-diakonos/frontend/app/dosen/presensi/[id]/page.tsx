    ...
    <div className="space-y-6">
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              ...
              <DialogContent className="bg-white">
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleCreatePresensi} disabled={isSaving} className='cursor-pointer
                              transition-all duration-200
                              active:scale-90'>
                ...
                {hasMateriOrCatatan ? (
                  <div className="p-4 bg-muted rounded-lg space-y-2 text-sm border relative">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="absolute right-2 top-2 h-8 gap-1 cursor-pointer
                              transition-all duration-200
                              active:scale-90"
                  ...
                  <Alert className="border-dashed">
                    ...
                    <AlertDescription className="flex items-center justify-between text-sm">
                      ...
                      <Button variant="outline" size="sm" onClick={handleOpenEditDialog} className="gap-1 cursor-pointer
                              transition-all duration-200
                              active:scale-90">
                        <Edit className="h-3.5 w-3.5" />
                        Tambah
      ...
      <Dialog open={isKeteranganDialogOpen} onOpenChange={setIsKeteranganDialogOpen}>
        <DialogContent className="bg-white">
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsKeteranganDialogOpen(false)} className='cursor-pointer
                              transition-all duration-200
                              active:scale-90'>
              Batal
            </Button>
            <Button onClick={handleSaveKeterangan} className='cursor-pointer
                              transition-all duration-200
                              active:scale-90' variant='outline'>Simpan</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
